...
public class BMW extends Car{
	...
	public void speedCal() {
		...
		int carSpeed = super.min_speed; //CAR  //super keyword used to access the parent class variable  //this super keyword can be in any line of statement.
...
/*	public BMW() {
		super();  //BMW calling default super class constructor //no need to create Car object to call Car class. 
		System.out.println("BMW const....");
	}*/
	
	public BMW() {
		super("BMW X1" , 90);  //BMW calling parameterized super class constructor //no need to create Car object to call Car class.  //only const calling super() keyword must be first line.
		System.out.println("BMW const....");
